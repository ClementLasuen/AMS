...
nb_iterations=0.
proba=1.
resultat_var_numrep = [ [ [0,0] for j in range(10)] for i in range(10)];
resultat_var_numrep=[]
# for i in range(10):
#     numrep = (i+1)*100;
#     #pour un numrep fixé, on fait 10 AMS (indice j)
#     #faire l'AMS !!!!!!!!!!!!!!!!!!!!!!
#     print(i)
#     for j in range(100):
#         #resultat_var_numrep[i][j][0]= nb_iterations;
#         #resultat_var_numrep[i][j][1]= proba;
#         AMS(numrep)
#         resultat_var_numrep.append([nb_iterations,proba]);
# 
# np.save("resultat_var_numrep.npy",resultat_var_numrep);
